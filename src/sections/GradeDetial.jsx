...
const GradeDetial = () => {
  ...
  return (
    <section >
      <div>
        <Hema scrollToFeatures={scrollTonext} text={[`${matchedGrade.name}`]} image={'/grades/hero.png'} />
      </div>

      <div className='flex flex-col items-center justify-center gap-10 h-[100vh] ' ref={scrollRef}>
