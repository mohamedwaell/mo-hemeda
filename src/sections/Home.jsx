...
const Home = () => {
  return ( 
    <>
      ...
      <section className='flex flex-col items-center justify-between  flex-col md:flex-row h-screen bg-cover bg-center bg-no-repeat bg-fixed bg-white dark:bg-black musuem ' style={{ backgroundImage: "url('./home/bg.png')" }}>
      ...
      <div className='flex items-center justify-center flex-col h-full md:w-1/2 h-[50vh] '>
        ...
        <Link to={'/about'} className='flex items-center justify-center bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700
         ...
         <img src="./home/flag.png" alt="" className='w-10 mr-5'/>
