...
const Home = () => {
  return ( 
    <>
      ...
      <section className='bg-[url("./home/bg.png")] flex flex-col items-center justify-between  flex-col md:flex-row h-screen bg-cover bg-center bg-no-repeat bg-fixed bg-white dark:bg-black musuem '>
