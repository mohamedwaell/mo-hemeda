...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 m-4 px-4 rounded-xl flex justify-between items-center z-50 bg-[#000] dark:bg-[#fff]">
      ...
      >
       <img src='/home/navButton.gif' className='absolute w-20 h-20 object-contain'></img>
      </button>
      <p className='text-white text-2xl dark:text-[#000]'>{isDark ? 'الوضع الفاتح' : 'الوضع المظلم'}</p>
      </div>
