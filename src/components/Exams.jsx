    ...
    return (
      <div className="min-h-screen mt-20 flex items-center justify-center p-4">
        <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-2xl text-center">
          ...
          <button
            onClick={startExam}
            className="px-8 py-4 bg-indigo-600 text-white font-bold rounded-lg shadow-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition-all duration-200 text-lg"
          >
            بدء الامتحان
          </button>
        </div>
