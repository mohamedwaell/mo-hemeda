...
const WhatsAppButton = () => {
  ...
  return (
    <button
      ...
      className="card fixed bottom-5 right-5 z-45 flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-full bg-green-500 hover:bg-green-600 text-white shadow-xl transform transition-all duration-200
